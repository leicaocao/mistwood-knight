...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function _g(s,e,t){let n=new Float32Array(Vi),i=new D(0,1,0);return new $t({name:"SphericalGaussianBlur",defines:{n:Vi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function wu(){return new $t({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function Ru(){return new $t({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Po(),fragmentShader:`
	...
	`}var Co=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},i=[n,n,n,n,n,n];this.texture=new sr(i),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var v0={[Rc]:"Linear",[Cc]:"Reinhard",[Ic]:"Cineon",[_r]:"ACESFilmic",[Lc]:"AgX",[Dc]:"Neutral",[Pc]:"Custom"};function y0(s,e){let t=v0[e];return t===void 0?(be("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var wo=new D;function M0(){He.getLuminanceCoefficients(wo);let s=wo.x.toFixed(4),e=wo.y.toFixed(4),t=wo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}var I0={[gr]:"SHADOWMAP_TYPE_PCF",[bs]:"SHADOWMAP_TYPE_VSM"};function P0(s){return I0[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var L0={[ui]:"ENVMAP_TYPE_CUBE",[Ui]:"ENVMAP_TYPE_CUBE",[xr]:"ENVMAP_TYPE_CUBE_UV"};function D0(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":L0[s.envMapMode]||"ENVMAP_TYPE_CUBE"}var N0={[Ui]:"ENVMAP_MODE_REFRACTION"};function U0(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":N0[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}var F0={[wc]:"ENVMAP_BLENDING_MULTIPLY",[tu]:"ENVMAP_BLENDING_MIX",[nu]:"ENVMAP_BLENDING_ADD"};function O0(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":F0[s.combine]||"ENVMAP_BLENDING_NONE"}function B0(s){let e=s.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function z0(s,e,t,n){let i=s.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,c=P0(t),l=D0(t),h=U0(t),d=O0(t),u=B0(t),f=S0(t),g=b0(r),v=i.createProgram(),m,p,M=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Er).join(`
`)),a=al(a),a=Bu(a,t),a=zu(a,t),o=al(o),o=Bu(o,t),o=zu(o,t),a=ku(a),o=ku(o),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
